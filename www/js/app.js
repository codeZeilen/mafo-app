...
.directive('dynamicContent', function ($compile) {
  return {
    restrict: 'A',
    replace: true,
...
.config(function($stateProvider, $urlRouterProvider, $ionicConfigProvider, $translateProvider) {
  ...
  .state('app', {
    ...
    .state('app.speaker', {
      ...
      views: {
        'menuContent': {
          templateUrl: "templates/program/speaker.html",
